...
CONFIG_KEY_TO_PREDICATE = {
    ...
    "bacnet_interface": "bacnetInterface",
    "bacnet_port": "bacnetPort",
    "bacnet_broadcast_address": "bacnetBroadcastAddress",
    "bacnet_apdu_timeout_ms": "bacnetApduTimeoutMs",
    "bacnet_device_instance": "bacnetDeviceInstance",
