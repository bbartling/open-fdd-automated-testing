...
SPARQL over the unified ``data_model.ttl`` (same file as the API graph). The
library package ``open-fdd`` stays RDF-free; this module is stack-only.

Requires **rdflib** (declared in ``openfdd-afdd-stack`` ``pyproject.toml``).
"""
